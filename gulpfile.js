'use strict';
// generated on 2016-02-01 using generator-gulp-bootstrap3 0.4.4
...
gulp.task('browserify', function() {
  ...
  var bundler = browserify({basedir: 'src/js'});
  bundler.add(['index.ts', '../../typings/tsd.d.ts'])
    .plugin(tsify)
...
gulp.task('default', ['clean', 'sprites', 'iconfont'], function() {
  gulp.start('css', 'browserify', 'images', 'templates', 'fonts', 'json');
});
...
gulp.task('watch', ['connect', 'serve'], function() {
  ...
  // Watch TS files
  gulp.watch(paths.tsfiles, ['browserify']);
